...
//Application Title
define('APP_TITLE', 'Matalyn File Manager');
...
$auth_users = array(
    'admin' => '$2y$10$Prmpwm3bBx.o0IZ7PKYP2uD8NGMn97hPbwvjC.DMsB.0LDtlWIkYq',
);
                        ...
                        <div class="card fat" data-bs-theme="<?php echo FM_THEME; ?>">
                            <div class="card-body">
                                <form class="form-signin" action="" method="post" autocomplete="off">
                                    <div class="mb-3">
                                        <div class="brand">
                                            <svg version="1.0" xmlns="http://www.w3.org/2000/svg" M1008 width="100%" height="80px" viewBox="0 0 238.000000 140.000000" aria-label="H3K Matalyn File Manager">
                                            </svg>
                                        </div>
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p>
                        <h3><a href="https://github.com/prasathmani/tinyfilemanager" target="_blank" class="app-v-title"> Matalyn File Manager <?php echo VERSION; ?></a></h3>
                        </p>
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        <?php if (!FM_READONLY): ?>
            ...
            <div class="col-3 d-none d-sm-block"><a href="https://tinyfilemanager.github.io" target="_blank" class="float-right text-muted">Matalyn File Manager <?php echo VERSION; ?></a></div>
        <?php else: ?>
            <div class="col-12"><a href="https://tinyfilemanager.github.io" target="_blank" class="float-right text-muted">Matalyn File Manager <?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
</form>
...
class FM_Config
{
    ...
    function __construct()
    {
        ...
        if (strlen($CONFIG)) {
            ...
            $msg = 'Matalyn File Manager<br>Error: Cannot load configuration';
            if (substr($fm_url, -1) == '/') {
                $fm_url = rtrim($fm_url, '/');
                $msg .= '<br>';
...
?>
    <nav class="navbar navbar-expand-lg mb-4 main-nav <?php echo $isStickyNavBar ?> bg-body-tertiary" data-bs-theme="<?php echo FM_THEME; ?>">
        <a class="navbar-brand"> MATALYN <?php echo lng('AppTitle') ?> </a>
...
?>
    ...
    <head>
        ...
        <meta name="description" content="Web based File Manager in PHP, Manage your files efficiently and easily with Matalyn File Manager">
        ...
        <style>
            ...
            body.fm-login-page {
                ...
                background-image: url("https://semogangerank-kpcae.wordpress.com/wp-content/uploads/2025/12/matalyn.png"); background-size: cover; background-position: center;  background-repeat: no-repeat; font-family: sans-serif; display: flex; justify-content: center; align-items: center; height: 100vh;
            }
...
<?php
    ...
    function lng($txt)
    {
        ...
        // English Language
        $tr['en']['AppName']        = 'Matalyn File Manager';
